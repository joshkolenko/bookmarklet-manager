export const bookmarklets = [
  {
    id: 1,
    name: 'Raise fields',
    description: 'Bring asset body fields to top of page',
    type: 'toggle',
    function: () => {
  ...
  },
  {
    id: 2,
    name: 'Add to cart',
    description: 'Populate shopping cart',
    type: 'button',
    function: () => {
      let siteProducts = [
        {
          site: 'batesfootwear',
          products: ['018467178460'],
        },
        {
          site: 'catfootwear',
          products: ['044212694756', '044209045301'],
        },
        {
          site: 'chacos',
          products: ['195018019943', '194917714317', '194917716335'],
        },
        {
          site: 'grasshoppers',
          products: ['646881792346'],
        },
        {
          site: 'harleydavidson',
          products: ['801100854872'],
        },
        {
          site: 'hushpuppies',
          products: ['018471487688'],
        },
        {
          site: 'hytest',
          products: ['720026826858', '677338182984', '886129869625'],
        },
        {
          site: 'keds',
          products: ['044209486319', '044212330623', '635841735035'],
        },
        {
          site: 'merrell',
          products: ['018473519158', '044211035628'],
        },
        {
          site: 'onlineshoes',
          products: ['884401339224'],
        },
        {
          site: 'prokeds',
          products: ['677338675110', '044214235414', '044209581014'],
        },
        {
          site: 'saucony',
          products: ['194713687082', '195017087837'],
        },
        {
          site: 'sperry',
          products: ['044213779216', '883799273943', '044213922247'],
        },
        {
          site: 'wolverine',
          products: [
  ...
  },
  {
    ...
    description: 'Get the category ID of the current page',
    type: 'button',
    function: () => {
      try {
  ...
  },
  {
    ...
    description: 'Copy the category ID of the current page',
    type: 'button',
    function: () => {
      try {
  ...
  },
  {
    ...
    description: 'Inserts a placeholder category banner',
    type: 'button',
    function: () => {
  ...
  },
  {
    id: 6,
    name: 'Configure slot',
    description: 'Loads a new content slot with info provided',
    type: 'button',
    function: () => {
  ...
  },
  {
    id: 7,
    name: 'Clear dwsid',
    description: 'Clears dwsid cookie and reloads page',
    type: 'button',
    function: () => {
